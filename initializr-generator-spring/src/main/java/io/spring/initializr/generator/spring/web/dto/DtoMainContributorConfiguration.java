...
public class DtoMainContributorConfiguration {
	...
	public MainCodeContributor<DtoMainCustomizer> dtoMainContributor(
		...
		return new MainCodeContributor<>(this.packageName, CLASS_NAME, DtoMainCustomizer.class, dtoMainCustomizers);
	}
	...
	public DtoMainCustomizer dtoMainFiledCustomizer() {
		return (typeDeclaration) -> typeDeclaration.addFieldDeclaration(
				JavaFieldDeclaration.field("message").modifiers(Modifier.PRIVATE | Modifier.FINAL).returning("String"));
	}
	...
	public DtoMainCustomizer dtoMainConstructorCustomizer() {
		return (typeDeclaration) -> typeDeclaration.addConstructorDeclaration(JavaConstructorDeclaration.constructor()
				.modifiers(Modifier.PUBLIC).parameters(new Parameter("String", "message"))
