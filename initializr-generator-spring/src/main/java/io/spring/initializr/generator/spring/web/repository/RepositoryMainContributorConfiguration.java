...
public class RepositoryMainContributorConfiguration {
	...
	public MainCodeContributor<RepositoryMainCustomizer> repositoryMainContributor(
		...
		return new MainCodeContributor<>(this.packageName, CLASS_NAME, RepositoryMainCustomizer.class,
	...
	public RepositoryMainCustomizer repositoryMainMethodCustomizer() {
		return (typeDeclaration) -> typeDeclaration.addMethodDeclaration(JavaMethodDeclaration.method("getHelloWorld")
				.modifiers(Modifier.PUBLIC).returning(this.entityClass)
