...
class RepositoryTestContributorConfigurationTest {
	...
	void testClassIsContributedWithCode() {
		...
		assertThat(project).textFile("src/test/java/com/example/demo/repository/HelloWorldRepositoryTest.java")
				.hasSameContentAs(
						new ClassPathResource("project/java/web/repository/HelloWorldRepositoryTest.java.gen"));
	}
