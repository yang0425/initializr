...
class ControllerGenerationConfigurationTests {
    ...
    void setup(@TempDir Path directory) {
        this.projectTester = new ProjectAssetTester().withIndentingWriterFactory()
            .withConfiguration(JavaProjectGenerationConfiguration.class,
                ControllerGenerationConfiguration.class)
    ...
    void mainClassIsNotContributedWithoutWebDependency() {
        ...
        assertThat(project)
            .doesNotContainFiles("src/main/java/com/example/demo/controller/HelloWorldController.java");
    }
    ...
    void mainClassIsContributed() {
        ...
        assertThat(project)
            .containsFiles("src/main/java/com/example/demo/controller/HelloWorldController.java");
    }
