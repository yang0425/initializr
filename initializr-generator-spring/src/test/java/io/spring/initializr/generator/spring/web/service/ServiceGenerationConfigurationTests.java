...
class ServiceGenerationConfigurationTests {
    ...
    void setup(@TempDir Path directory) {
        this.projectTester = new ProjectAssetTester().withIndentingWriterFactory()
            .withConfiguration(JavaProjectGenerationConfiguration.class,
                ServiceGenerationConfiguration.class)
    ...
    void mainClassIsNotContributedWithoutWebDependency() {
        ...
        assertThat(project)
            .doesNotContainFiles("src/main/java/com/example/demo/service/HelloWorldService.java");
    }
    ...
    void mainClassIsContributed() {
        ...
        assertThat(project)
            .containsFiles("src/main/java/com/example/demo/service/HelloWorldService.java");
    }
