...
class ControllerTestContributorConfigurationTest {
	...
	void testClassIsContributedWithCode() {
		...
		assertThat(project).textFile("src/test/java/com/example/demo/controller/HelloWorldControllerTest.java")
				.hasSameContentAs(
						new ClassPathResource("project/java/web/controller/HelloWorldControllerTest.java.gen"));
	}
